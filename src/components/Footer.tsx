        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <a href="tel:+62895428433006" className="flex items-start gap-4 group">
                <div className="mt-1 text-[#c5a059]"><Phone size={16} /></div>
                <div>
                  <p className="text-[10px] uppercase font-bold text-[#2d2a26]/30 tracking-widest mb-1">Office Line</p>
                  <p className="text-sm text-[#2d2a26] group-hover:text-[#c5a059] transition-colors">+62 895 4284 33006</p>
                </div>
              </a>
