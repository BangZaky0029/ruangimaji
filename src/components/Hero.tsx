...
{word}<br />
...
</h1>        <p className="text-[#2d2a26]/60 text-sm md:text-base max-w-sm mb-10 leading-relaxed font-light">
          {HERO_SLIDES_DATA[activeIdx].description}
        </p>
      </motion.div>
    </div>    <div className="hidden lg:flex flex-col items-end gap-8 self-end pb-12 overflow-visible mr-[-2rem]">
      ...
      </div>      <div className="flex items-center gap-8 pr-4">
