...
const Hero: React.FC = () => {
  ...
  if (loading || heroSlides.length === 0) {
    return (
      <section className="relative h-screen w-full bg-[#fbfaf8] overflow-hidden flex items-center justify-center">
        <div className="text-[#c5a059]/40 animate-pulse">Loading...</div>
      </section>
    );
  }
