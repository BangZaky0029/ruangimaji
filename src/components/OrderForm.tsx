...
const OrderForm: React.FC<OrderFormProps> = ({ onClose, packages, whatsappNumber, serviceId }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.from('orders').insert([{
        ...
        package_price_snapshot: Math.round(formData.selected_package_price),
      ...
      console.error('System error in OrderForm submission:', err);
